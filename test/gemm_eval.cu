...
int main(int argc, char **argv)
{
    ...
    csv << "Size,MyGEMM_GFLOPS,CUBLAS_GFLOPS\n";
    ...
    for (size_t N = STRIDE; N <= MAX_X; N += STRIDE)
    {
        ...
        std::cout << "Size: " << N << ", GFLO: " << gflo
                  << ", MyGEMM: Time=" << my_sec << "sec, Performance=" << my_gflops << " GFLOPS"
                  << ", CUBLAS: Time=" << cublas_sec << "sec, Performance=" << cublas_gflops << " GFLOPS"
                  << ", ratio=" << my_gflops / cublas_gflops << std::endl;
